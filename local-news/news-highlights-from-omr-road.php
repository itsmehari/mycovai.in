...
<?php $breadcrumbs = [
  ...
  ['https://mycovai.in/local-news/news-highlights-from-omr-road.php','News Highlights']
]; ?>
...
<section class="container py-4">
  ...
  <div class="d-flex gap-2 flex-wrap">
    <a class="btn btn-sm btn-outline-secondary" target="_blank" href="https://wa.me/?text=<?php echo urlencode('This Weekend in OMR – curated roundup: https://mycovai.in/local-news/this-weekend-in-omr.php?utm_source=whatsapp&utm_medium=social&utm_campaign=weekend_roundup'); ?>">Share on WhatsApp</a>
    <a class="btn btn-sm btn-outline-secondary" target="_blank" href="https://t.me/share/url?url=<?php echo urlencode('https://mycovai.in/local-news/this-weekend-in-omr.php?utm_source=telegram&utm_medium=social&utm_campaign=weekend_roundup'); ?>&text=<?php echo urlencode('This Weekend in OMR – curated roundup'); ?>">Share on Telegram</a>
  </div>
</section>
...
<section class="container py-5">
  ...
  <div class="text-center mt-4">
    <a href="covai-directory-list.php" class="btn btn-primary">View All Businesses</a>
  </div>
</section>
<?php endif; ?>
