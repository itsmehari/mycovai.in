...
<title>Will OMr's Internal Roads be Fixed, as corporation allots funds to relay damages interior road? 2022 - OMR News</title>
<meta charset="utf-8">
...
<h2>Chennai Corporation plans to relay damaged roads - Will perungudi be covered?</h2>
<section class="news">
    <p style="font-weight: bold; font-size:1.5em">400 Cr Budgedt to be alloted for 200 Wards</p>
  <img src="../OMR-Water-Logging-Issue-Dilapidated-Roads-Of-Perungudi-Chennai-Myomr.jpg" style="max-width: 720px;" class="responsive">

  <h5>OMR News, Apr 28, 2022</h5>
  <p>
Residents in many locations have urged that interior roadways be rerouted. Many of them would be re-laid in the near future. The 200 ward councillors would plan ahead.</p>
<p>According to Municipal Administration Minister's declaration in the Assembly, Corporation Commissioner Gagandeep Singh Bedi claimed the civic body would begin operations this year. "We've requested a list of highways from the zones." He stated that "roads over five years old will be prioritised based on damage."
</p>
<p>The Question Raised by residents of OMR is will their areas be noted - There are roads which have not been restored for more than five years. Commuters bear the burnt of dilapidated roads day in day out, Typical examples are CORPORATION ROAD, and few roads in seevaram area. Will this allotment serve its purpose, The residents have to wait and watch.</p>
  <br>
        <br>
