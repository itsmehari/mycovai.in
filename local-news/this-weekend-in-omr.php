...
$canonical_url = 'https://mycovai.in/local-news/this-weekend-in-omr.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<header class="py-5" style="background:linear-gradient(90deg,#9ebd13 0%, #008552 100%); color:#fff;">
  <div class="container">
    ...
    <div><a class="btn btn-light btn-sm" href="/local-events/weekend.php">Browse all weekend events</a></div>
    <div class="mt-2 d-flex gap-2 flex-wrap">
      <?php $roundupUrl = 'https://mycovai.in/local-news/this-weekend-in-omr.php'; ?>
