...
<?php $breadcrumbs = [
  ...
  ['https://mycovai.in/local-news/news-highlights.php','News & Blog']
]; ?>
...
<?php include '../components/head-resources.php'; ?>
    ...
    <meta name="description" content="Stay updated with the latest news, events, businesses, and jobs in Coimbatore. Find local services and community updates at MyCovai.">
    <meta name="keywords" content="Coimbatore, Covai, MyCovai, RS Puram, Gandhipuram, Saibaba Colony, Peelamedu, Race Course, Sungam, Saravanampatti, Kovaipudur, local news, community.">
    <meta name="author" content="<?php echo defined('SITE_NAME') ? htmlspecialchars(SITE_NAME) . ' Team' : 'MyCovai Team'; ?>">
    <title>Coimbatore News & Community | Local Businesses & Events | MyCovai</title>
    <!-- Bootstrap CSS -->
    ...
    <link rel="icon" href="<?php echo (defined('SITE_LOGO_URL') && SITE_LOGO_URL) ? SITE_LOGO_URL : '/My-OMR-Logo.jpg'; ?>" type="image/jpeg">
...
<section class="container py-5">
  <h2 class="text-center mb-4" style="font-family: 'Playfair Display', serif; color: #008552;"><?php echo defined('SITE_NAME') ? SITE_NAME : 'MyCovai'; ?> News & Blog</h2>
...
<section class="container py-4">
  <div class="alert alert-success d-flex justify-content-between align-items-center">
    <div>
      <strong>This Weekend in Covai:</strong> See our curated roundup of the best events.
    </div>
    <div class="d-flex gap-2">
      <a class="btn btn-success" href="/local-events/?utm_source=news&utm_medium=internal&utm_campaign=weekend_roundup">View Events</a>
      <a class="btn btn-outline-success" href="/local-events/post/?utm_source=news&utm_medium=internal&utm_campaign=list_event">List your event</a>
    </div>
  </div>
  <div class="d-flex gap-2 flex-wrap">
    <a class="btn btn-sm btn-outline-secondary" target="_blank" href="https://wa.me/?text=<?php echo urlencode('Coimbatore Events – https://mycovai.in/local-events/?utm_source=whatsapp&utm_medium=social'); ?>">Share on WhatsApp</a>
    <a class="btn btn-sm btn-outline-secondary" target="_blank" href="https://t.me/share/url?url=<?php echo urlencode('https://mycovai.in/local-events/'); ?>&text=<?php echo urlencode('Coimbatore events on MyCovai'); ?>">Share on Telegram</a>
  </div>
</section>

<!-- Featured Events -->
<section class="container py-5">
  <h2 class="text-center mb-4" style="font-family: 'Playfair Display', serif; color: #008552;">Featured Events in Coimbatore</h2>
  ...
  <div class="text-center mt-3">
    ...
    <a class="btn btn-outline-success" href="/local-events/post/">List your event</a>
  </div>
</section>
...
<section class="container py-5">
  ...
  <div class="text-center mt-4">
    <a href="/local-events/" class="btn btn-primary">View Events</a>
  </div>
</section>
<?php endif; ?>
...
<div class="modal-overlay" id="modalOverlay">
    <div class="modal">
        ...
        <h2>Unlock Exclusive Access to <?php echo defined('SITE_NAME') ? SITE_NAME : 'MyCovai'; ?></h2>
        <ul>
            <li>✔ Get the latest Covai news & updates</li>
            ...
            <li>✔ Connect with the Covai community in one platform</li>
        </ul>
        <button onclick="window.location.href='tel:+919445088028'">Call Us for Discussion</button>
    </div>
</div>
