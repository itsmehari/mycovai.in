...
<title>New Road side Park being constructed in Perungudi, Corporation Road, as a part of beautification</title>
<meta charset="utf-8">
...
<a href="https://www.youtube.com/channel/UCyFrgbaQht7C-17m_prn0Rg" class="fa" target="_blank"><img src="https://cdn1.iconfinder.com/data/icons/logotypes/32/youtube-128.png" width="30px;"></a>
  <!-- ---------------------------------------------------news article--------------------------------------------- -->
      ...
      <h2>in Corporation Road, Seevaram, Perungudi</h2>
      <section class="news">
          <p style="font-weight: bold; font-size:1.5em">Ward 194 -- Welcome Move on May 1st</p>
        <div><img src="../Perungudi-Corporation-Road-Road-Side-Park-Namakku-Naame-Scheme-May-2022.jpg" style="max-width: 720px;" class="responsive"></div>

        <h5>OMR News, May 01, 2022</h5>
        <p>On May day we witnessed civil works were going on in corporation road, next to amma unavagam. Upon enquiry it was known that the works were for construction of a small roadside park, Under namakku namme scheme of TN Govt. </p>
        <p>Good to see a small step towards beautification of localities.</p>
        <br>
        <br>
