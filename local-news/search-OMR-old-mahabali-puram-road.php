...
<title>Local Search for OMR Road - Search for Places, Businesses, ATMs, Schools, Services, Govt Offices in OMR Road, Old Mahabalipuram Road</title>
<meta charset="utf-8">
...
<a href="https://www.youtube.com/channel/UCyFrgbaQht7C-17m_prn0Rg" class="fa" target="_blank"><img src="https://cdn1.iconfinder.com/data/icons/logotypes/32/youtube-128.png" width="30px;"></a>
  <div class="card bg-info text-white">
    <div class="card-body">We are working on this online search portal exclusive for OMR Road and its residents, if you want your business to be listed here in this search, please mail us or contact through our social media (fb, insta and twitter) we will respond immediately. 
    also here is our mail id. myomrnews@gmail.com</div>
  </div>
  <br>
<!--       <h1 style="color:green; padding-top:40px;">-->
<!--         Home Based Learning - Computer Courses-->
<!--       </h1>-->
<!--<p>Computer Classes - One to One Training, Practical Oriented Professional Courses-->
<!--</p>-->
<!--<img src="Python-C-C-Plus-Java-Computer-Programming-Courses-in-OMR.jpg" width="200" alt="Computer coursed brochure, Python, C, C++, Java Training in OMR Road">-->
   </div>
    </div>
  </div>
</div>
