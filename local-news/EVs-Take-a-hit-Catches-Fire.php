...
<title>Electric Vehicles Take a Huge Hit as Most EV's Catches First due to Scorching Sun - 2022</title>
<meta charset="utf-8">
...
<h2>EVs Take a hit</h2>
<section class="news">
    <p style="font-weight: bold; font-size:1.5em">People expected to be more skeptical about buying a new EV for atleast an year</p>
  <div><img src="../Ev-Accident-Incident.jpg" style="max-width: 720px;"></div>

  <h5>OMR News, Apr 24, 2022</h5>
  <p>With frequent news on EVs getting burnt and reported deaths, the EV sales is all set to take a slump, with concerns raised over saftey. The EV Companies and Govt are taking measures to analyse the reson for the rising mishaps. </p>
  <p>If you are planning to buy an EV of your desired choice, now is a time to step back, and wait for updates and upgrades to the same. Tentatively this will take a year or more for companies and research organisations to come up with causes and rectifications and implimentations of new safety guidelines.</p>
  <p>
  in OMR and surrounding we have multiple brand showrrooms, which may get affected in sales due to this news.</p>
  <p style="font-size:.9em"><strong>RELATED NEWS: </strong>Ola Electric is recalling 1,441 units of its electric two-wheelers in the wake of incidents of vehicles catching fire, according to a company statement. The company said its investigation into the fire incident on March 26, in Pune, is ongoing and preliminary assessment found that it was an isolated one</p>
  <br>
        <br>
