<?php
/**
 * URL Helper Functions – canonical base for Google Search Console
 * All canonicals use this base so Search Console sees one preferred domain.
 */
if (!defined('SITE_CANONICAL_BASE')) {
    define('SITE_CANONICAL_BASE', 'https://mycovai.in');
}

/**
 * Return the canonical base URL (no trailing slash).
 * @return string e.g. https://mycovai.in
 */
function get_canonical_base() {
    return rtrim(SITE_CANONICAL_BASE, '/');
}

/**
 * Get the canonical URL for the current page
 * Always returns SITE_CANONICAL_BASE (https://mycovai.in) version
 *
...
function normalize_url($url) {
    ...
    $host = isset($parsed['host']) ? preg_replace('/^www\./', '', $parsed['host']) : 'mycovai.in';
