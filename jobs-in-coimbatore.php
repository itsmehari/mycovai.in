...
<head>
    ...
    <!-- Job Portal Styles -->
    <link rel="stylesheet" href="jobs/assets/job-listings-covai.css">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto text-center mb-5">
                    ...
                    <p class="text-muted">Find and apply for jobs in Coimbatore in 4 simple steps</p>
                </div>
            </div>
            <div class="row g-4">
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <div class="text-center mb-5">
                        ...
                        <p class="text-muted">Everything you need to know about finding jobs in Coimbatore</p>
                    </div>
                    ...
                    <div class="faq-item">
                        <button class="faq-question">
                            <span>What areas in Coimbatore are covered?</span>
                            <i class="fas fa-chevron-down"></i>
                        </button>
                        <div class="faq-answer">
                            We cover neighbourhoods across Coimbatore including RS Puram, Gandhipuram, Peelamedu, Saibaba Colony, Saravanampatti, Race Course, and more.
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row g-3">
                <div class="col-md-3 col-sm-6">
                    <a href="/it-jobs-coimbatore.php" class="card card-hover text-decoration-none h-100">
                        <div class="card-body text-center">
                            <i class="fas fa-laptop-code fa-2x text-primary mb-2"></i>
                            <h5 class="card-title mb-0">IT Jobs in Coimbatore</h5>
                        </div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="/jobs-in-peelamedu.php" class="card card-hover text-decoration-none h-100">
                        <div class="card-body text-center">
                            <i class="fas fa-map-marker-alt fa-2x text-primary mb-2"></i>
                            <h5 class="card-title mb-0">Jobs in Peelamedu</h5>
                        </div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="/jobs-in-rs-puram.php" class="card card-hover text-decoration-none h-100">
                        <div class="card-body text-center">
                            <i class="fas fa-user-graduate fa-2x text-primary mb-2"></i>
                            <h5 class="card-title mb-0">Jobs in RS Puram</h5>
                        </div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="/jobs-in-gandhipuram.php" class="card card-hover text-decoration-none h-100">
                        <div class="card-body text-center">
                            <i class="fas fa-clock fa-2x text-primary mb-2"></i>
                            <h5 class="card-title mb-0">Jobs in Gandhipuram</h5>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto text-center">
                    <h2 class="h2 mb-4">Ready to Find Your Dream Job in Coimbatore?</h2>
                    ...
                    <p class="mt-4 mb-0">
                        <small>
                            ...
                            <i class="fas fa-map-marker-alt me-1"></i> Coimbatore Local • 
