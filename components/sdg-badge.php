...
function autoDetectSDGBadges() {
    ...
    $mappings = [
        // Hostels & PGs
        '/hostels-pgs' => [1, 11],
        '/hostels-pgs/index.php' => [1, 11],
        '/hostels-pgs/property-detail.php' => [1, 11],
        
        // Coworking Spaces
        '/coworking-spaces' => [8, 9],
        '/coworking-spaces/index.php' => [8, 9],
        '/coworking-spaces/space-detail.php' => [8, 9],
        ...
        // Schools
        '/directory/schools.php' => [4],
        '/directory/schools' => [4],
        
        // Hospitals
        '/directory/hospitals.php' => [3],
        '/directory/hospitals' => [3],
        
        // Restaurants
        '/directory/restaurants.php' => [2],
        '/directory/restaurants' => [2],
        
        // Banks & ATMs
        '/directory/banks.php' => [1],
        '/directory/banks' => [1],
        '/directory/atms.php' => [1],
        '/directory/atms' => [1],
        
        // IT Companies
        '/directory/it-companies.php' => [9, 8],
        '/directory/it-companies' => [9, 8],
        '/directory/it-company.php' => [9, 8],
        
        // Parks
        '/directory/parks.php' => [15, 11],
        '/directory/parks' => [15, 11],
        
        // Government Offices
        '/directory/government-offices.php' => [16],
        '/directory/government-offices' => [16],
        ...
        // SDG Page itself
        '/discover/sustainable-development-goals.php' => [], // No badges on SDG page itself
    ];
    ...
    // Check partial match (e.g., /hostels-pgs/property-detail.php?id=123)
...
if (!empty($sdg_badges) && is_array($sdg_badges)) {
    ...
    foreach ($sdg_badges as $sdg_number) {
        ...
        if ($sdg_number >= 1 && $sdg_number <= 17) {
            $badge_url = '/discover/sustainable-development-goals.php';
