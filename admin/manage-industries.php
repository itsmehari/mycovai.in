...
$table = covai_table('industries');
$list_script = 'manage-industries.php';
...
if ($q !== '') {
    ...
    $where = " WHERE industry_name LIKE '" . $esc . "' OR address LIKE '" . $esc . "'";
}
...
$sql = 'SELECT slno, industry_name, address, contact, industry_type FROM `' . $table . '`' . $where;
$sql .= ' ORDER BY industry_name ASC LIMIT ' . (int) $pagination['limit'] . ' OFFSET ' . (int) $pagination['offset'];
$res = $conn->query($sql);
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <main class="col-md-9 ml-sm-auto col-lg-10 px-4 main-content" aria-label="Main content">
      ...
      <div class="table-responsive bg-white p-3">
        <table class="table table-bordered table-hover">
          <thead class="thead-dark"><tr><th>#</th><th>Name</th><th>Type</th><th>Address</th><th>Contact</th><th>Actions</th></tr></thead>
          <tbody>
