...
$sql = 'SELECT slno, schoolname, address, locality, verified FROM `' . $t . '`' . $where . ' ORDER BY schoolname ASC LIMIT ' . $per_page . ' OFFSET ' . $offset;
$res = $conn->query($sql);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Manage Schools - MyCovai</title>
