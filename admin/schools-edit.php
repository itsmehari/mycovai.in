...
// Fetch
$stmt = $conn->prepare('SELECT slno, schoolname, address, locality, about, services, careers_url FROM `' . covai_table('schools') . '` WHERE slno = ?');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $upd = $conn->prepare('UPDATE `' . covai_table('schools') . '` SET about = ?, services = ?, careers_url = ? WHERE slno = ?');
...
<head>
  ...
  <title>Edit School - MyCovai</title>
