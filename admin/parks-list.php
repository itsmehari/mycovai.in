...
$sql = 'SELECT slno, parkname, location FROM `' . $t . '`' . $where . ' ORDER BY parkname ASC LIMIT ' . $per_page . ' OFFSET ' . $offset;
$res = $conn->query($sql);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Manage Parks - MyCovai</title>
      ...
      <form method="get" class="mb-3">
        <div class="input-group">
          ...
          <div class="input-group-append">
            ...
            <?php if ($search !== ''): ?><a href="parks-list.php" class="btn btn-secondary ml-2">Clear</a><?php endif; ?>
          </div>
        </div>
      </form>
