...
// Fetch
$stmt = $conn->prepare('SELECT slno, bankname, address, locality, about, services, careers_url FROM `' . covai_table('banks') . '` WHERE slno = ?');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $upd = $conn->prepare('UPDATE `' . covai_table('banks') . '` SET about = ?, services = ?, careers_url = ? WHERE slno = ?');
