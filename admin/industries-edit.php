...
$stmt = $conn->prepare('SELECT slno, industry_name, address, locality, industry_type, about, services, careers_url FROM `' . covai_table('industries') . '` WHERE slno = ?');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $upd = $conn->prepare('UPDATE `' . covai_table('industries') . '` SET about = ?, services = ?, careers_url = ? WHERE slno = ?');
...
<head>
  ...
  <title>Edit Industry - MyCovai</title>
