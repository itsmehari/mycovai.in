...
$table = covai_table('parks');
$list_script = 'manage-parks.php';
...
if ($q !== '') {
    ...
    $where = " WHERE parkname LIKE '" . $esc . "' OR location LIKE '" . $esc . "'";
}
...
$sql = 'SELECT slno, parkname, location, features FROM `' . $table . '`' . $where;
$sql .= ' ORDER BY parkname ASC LIMIT ' . (int) $pagination['limit'] . ' OFFSET ' . (int) $pagination['offset'];
$res = $conn->query($sql);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Manage Parks - Admin</title>
    ...
    <main class="col-md-9 ml-sm-auto col-lg-10 px-4 main-content" aria-label="Main content">
      ...
      <div class="table-responsive bg-white p-3">
        <table class="table table-bordered table-hover">
          <thead class="thead-dark"><tr><th>#</th><th>Name</th><th>Location</th><th>Features</th><th>Actions</th></tr></thead>
          <tbody>
