...
$canonical_url = "https://mycovai.in/pentahive/facebook";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="testimonial-card">
                        ...
                        <p class="testimonial-text">"Finally, we have control over our website. No more waiting for developers or paying high monthly fees."</p>
                        <div class="testimonial-author">
                            <strong>Restaurant Owner</strong><br>
                            <small>OMR Chennai</small>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="testimonial-card">
                        ...
                        <p class="testimonial-text">"Saved us ₹60,000 per year. The service is comprehensive and the support is excellent."</p>
                        <div class="testimonial-author">
                            <strong>School Administrator</strong><br>
                            <small>OMR Chennai</small>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="testimonial-card">
                        ...
                        <p class="testimonial-text">"Best investment we made. Full access to our website and ongoing maintenance at a fraction of agency costs."</p>
                        <div class="testimonial-author">
                            <strong>Service Business Owner</strong><br>
                            <small>OMR Chennai</small>
                        </div>
                    </div>
                </div>
