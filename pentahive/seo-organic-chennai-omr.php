...
$canonical_url = "https://mycovai.in/pentahive/chennai";
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <section class="content-block mb-5">
                        ...
                        <ul>
                            <li><a href="/directory/restaurants.php">Restaurants in OMR Chennai</a></li>
                            <li><a href="/directory/schools.php">Schools in OMR Chennai</a></li>
                            <li><a href="/directory/it-companies.php">IT Companies in OMR</a></li>
