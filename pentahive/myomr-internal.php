...
$canonical_url = "https://mycovai.in/pentahive/community";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="testimonial-card">
                        ...
                        <p class="testimonial-text">"As a MyOMR.in directory member, we trust the team. The website maintenance service has been excellent and affordable."</p>
                        <div class="testimonial-author">
                            <strong>Restaurant Owner</strong><br>
                            <small>Listed on MyOMR.in</small>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="testimonial-card">
                        ...
                        <p class="testimonial-text">"We've been using MyOMR.in for our business listing. When we needed website maintenance, we naturally turned to the same team."</p>
                        <div class="testimonial-author">
                            <strong>School Administrator</strong><br>
                            <small>MyOMR.in Community Member</small>
                        </div>
                    </div>
                </div>
            </div>
