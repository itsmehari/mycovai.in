...
<head>
    ...
    <title><?php echo htmlspecialchars($discover_label); ?> – Get Started</title>
    <meta name="description" content="Get started with <?php echo htmlspecialchars($discover_label); ?> – your local platform for news, jobs, events, and more in <?php echo htmlspecialchars($region_full); ?>. Join the community in a few easy steps!">
    <meta name="keywords" content="<?php echo htmlspecialchars($site_name); ?>, get started, onboarding, <?php echo htmlspecialchars($region_short); ?> community">
    <!-- Canonical URL -->
    <link rel="canonical" href="https://mycovai.in/discover/getting-started.php">
        ...
        <main class="container mx-auto px-4 py-8">
            <section class="text-center mb-12">
                <h1 class="text-4xl md:text-5xl font-bold text-green-800 mb-4">
                    Get Started with <?php echo htmlspecialchars($discover_label); ?>
                </h1>
                <p class="text-xl text-gray-600 max-w-2xl mx-auto mb-6">
                    Join the <?php echo htmlspecialchars($region_short); ?> community in just a few easy steps. Connect, discover, and thrive with local news, jobs, events, and more!
                </p>
            </section>
            <section class="grid md:grid-cols-3 gap-8 mb-12">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm flex flex-col items-center">
                    ...
                    <p class="text-gray-600">Browse news, jobs, events, business listings, and more tailored for <?php echo htmlspecialchars($region_short); ?>.</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-sm flex flex-col items-center">
            ...
            <section class="text-center bg-green-50 rounded-lg p-8 mb-12">
                ...
                <p class="text-gray-600 mb-6">Sign up now and start your journey with <?php echo htmlspecialchars($discover_label); ?>.</p>
            ...
            <section class="bg-green-50 rounded-lg p-6 mb-12">
                ...
                <p class="text-gray-700 mb-4"><?php echo htmlspecialchars($site_name); ?> serves Coimbatore, including RS Puram, Gandhipuram, Saibaba Colony, Peelamedu, Race Course, Sungam, Saravanampatti, and more.</p>
        ...
        <div class="fixed inset-0 bg-gray-900 bg-opacity-50 hidden" id="mobile-menu">
            <div class="bg-white h-full w-64 p-6">
                <div class="flex justify-between items-center mb-6">
                    <a href="/" class="text-2xl font-bold text-blue-600"><?php echo htmlspecialchars($site_name); ?></a>
