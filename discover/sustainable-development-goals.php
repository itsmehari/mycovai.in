...
<head>
    ...
    <meta name="description" content="Take action for sustainability in Coimbatore! Make your personal pledge, find local initiatives in RS Puram, Gandhipuram, Saibaba Colony, and connect with Covai businesses committed to SDGs. Start your sustainable journey today.">
    <meta name="keywords" content="UN SDG, Sustainable Development Goals, Coimbatore community, sustainability, Covai, MyCovai, community development">
    <meta name="author" content="<?php echo defined('SITE_NAME') ? htmlspecialchars(SITE_NAME) . ' Team' : 'MyCovai Team'; ?>">
    <title>UN Sustainable Development Goals | MyCovai Community Commitment | MyCovai</title>
    ...
    $sdg_site = defined('SITE_NAME') ? SITE_NAME : 'MyCovai';
    $page_title = "UN Sustainable Development Goals | " . $sdg_site . " Community Commitment";
    $page_description = $sdg_site . "'s commitment to UN Sustainable Development Goals. Learn how our Coimbatore community platform supports sustainable development and how you can participate.";
    $page_keywords = "UN SDG, Sustainable Development Goals, Coimbatore community, sustainability, Covai, " . $sdg_site . ", community development";
    $og_title = "UN Sustainable Development Goals | " . $sdg_site . " Community Commitment";
    $og_description = $sdg_site . "'s commitment announcement to UN Sustainable Development Goals";
    $og_image = "https://mycovai.in/My-OMR-Logo.jpg";
    $og_url = "https://mycovai.in/discover/sustainable-development-goals.php";
    ...
    <!-- Canonical URL -->
    <link rel="canonical" href="https://mycovai.in/discover/sustainable-development-goals.php">
    ...
    <script type="application/ld+json">
    {
      ...
      "@graph": [
        {
          "@type": "WebPage",
          "@id": "https://mycovai.in/discover/sustainable-development-goals.php",
          "name": "UN Sustainable Development Goals | <?php echo addslashes($sdg_site); ?> Community Commitment",
          "description": "<?php echo addslashes($sdg_site); ?>'s commitment to UN Sustainable Development Goals. Learn how our Coimbatore community platform supports sustainable development and how you can participate.",
          "url": "https://mycovai.in/discover/sustainable-development-goals.php",
          "inLanguage": "en-IN",
          "isPartOf": {
            "@type": "WebSite",
            "name": "<?php echo addslashes($sdg_site); ?>",
          ...
          "breadcrumb": {
            "@id": "https://mycovai.in/discover/sustainable-development-goals.php#breadcrumb"
          },
          "mainEntity": {
        ...
        },
        {
          ...
          "author": {
            "@type": "Organization",
            "name": "<?php echo addslashes($sdg_site); ?> Editorial Team",
            "url": "https://mycovai.in"
          },
          "publisher": {
            "@type": "Organization",
            "@id": "https://mycovai.in/#organization",
            "name": "<?php echo addslashes($sdg_site); ?>",
            "url": "https://mycovai.in",
            "logo": {
              "@type": "ImageObject",
          ...
          "keywords": "UN SDG, Sustainable Development Goals, Coimbatore community, sustainability, Covai, MyCovai, community development"
        },
        {
          "@type": "Organization",
          "@id": "https://mycovai.in/#organization",
          ...
          "description": "Digital community hub for Coimbatore",
          "address": {
            "@type": "PostalAddress",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              "@type": "ListItem",
              "position": 2,
              "name": "Discover <?php echo addslashes($sdg_site); ?>",
              "item": "https://mycovai.in/discover/"
            },
            {
              "@type": "ListItem",
              "position": 3,
              "name": "Sustainable Development Goals",
              "item": "https://mycovai.in/discover/sustainable-development-goals.php"
            }
          ]
        },
        {
          ...
          "description": "Complete list of all 17 UN Sustainable Development Goals (SDGs) and how <?php echo addslashes($sdg_site); ?> supports each goal",
          "numberOfItems": 17,
          "itemListElement": [
            {
              "@type": "ListItem",
...
<section class="sdg-hero">
    <div class="container">
        <h1>Your Coimbatore Community: Making Sustainability Real</h1>
        ...
        <div class="col-md-8 mx-auto">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <p>At <?php echo htmlspecialchars($sdg_site); ?>, we believe that sustainable development starts at the community level. Our platform is designed to support these global goals through local action, community engagement, and sustainable practices.</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- MyCovai's Primary SDG Alignment -->
<section class="mycovai-alignment">
    <div class="container">
        <div class="section-header">
            <h2 style="color: white;">How <?php echo htmlspecialchars($sdg_site); ?> Supports the SDGs</h2>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="alignment-card">
                    ...
                    <p>Through our local news, civic issue reporting, and community engagement, we're building a more resilient and inclusive Coimbatore community.</p>
                    <ul>
            ...
            <div class="col-md-6">
                <div class="alignment-card">
                    ...
                    <p>Our comprehensive school directory and educational resources promote inclusive and equitable quality education for all Coimbatore residents.</p>
                    <ul>
                    ...
                    <div style="margin-top: 20px; padding-top: 20px; border-top: 2px solid rgba(255,255,255,0.2);">
                        <a href="/discover/sdg-education-schools.php" class="btn btn-light btn-lg" style="background: white; color: #2e7d32; font-weight: 600;">
            ...
            <div class="col-md-6">
                <div class="alignment-card">
                    ...
                    <p>Our job listings and business directory support local economic development and employment opportunities in Coimbatore.</p>
                    <ul>
            ...
            <div class="col-md-6">
                <div class="alignment-card">
                    ...
                    <p>Our hospital directory and health awareness content ensure healthy lives and promote well-being for all Coimbatore residents.</p>
                    <ul>
...
<section class="container py-5">
    <div class="section-header">
        ...
        <p>Explore each goal and understand how <?php echo htmlspecialchars($sdg_site); ?> contributes to global sustainability</p>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="sdg-card sdg-1">
                ...
                <h3>No Poverty</h3>
                <p>End poverty in all its forms everywhere. <?php echo htmlspecialchars($sdg_site); ?> supports local economic development through job listings and business promotion.</p>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="sdg-card sdg-4">
                ...
                <a href="/discover/sdg-education-schools.php" class="btn btn-sm btn-light mt-2" style="color: #c5192d;">
...
<!-- How You Can Participate - Coimbatore Specific -->
<section class="container py-5">
    <div class="section-header">
        <h2>Three Ways to Take Action in Coimbatore</h2>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 shadow-sm border-top border-success border-4">
                <div class="card-body text-center">
                    ...
                    <h5 class="card-title">As a Covai Resident</h5>
                    <p class="card-text">Start today: Shop at <a href="/directory/restaurants.php">local Covai restaurants</a>, use our <a href="/directory/schools.php">school directory</a> to help neighbors, join <a href="/local-events/">community events</a> in RS Puram, Gandhipuram, or your area.</p>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 shadow-sm border-top border-primary border-4">
                <div class="card-body text-center">
                    ...
                    <h5 class="card-title">As a Covai Business</h5>
                    <p class="card-text">List your business on <?php echo htmlspecialchars($sdg_site); ?> and commit to sustainable practices. Whether you're a restaurant in RS Puram, an IT company in Peelamedu, or a school in Saibaba Colony - make your promise.</p>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 shadow-sm border-top border-warning border-4">
                <div class="card-body text-center">
                    ...
                    <p class="card-text">Start an SDG-focused event in your Covai area. Post it on <a href="/local-events/"><?php echo htmlspecialchars($sdg_site); ?> Events</a>, invite neighbors from Sungam, Peelamedu, RS Puram - build a sustainable community together.</p>
...
<!-- Coimbatore Impact & Local Actions -->
<section class="container py-5" style="background: #f8f9fa;">
    <div class="section-header">
        <h2>Your Impact Right Here in Coimbatore</h2>
    ...
    <div class="row mb-5">
        <div class="col-lg-6 mb-4">
            <div class="card h-100 shadow-sm border-0">
                <div class="card-body">
                    <h3 class="text-success"><i class="fas fa-map-marker-alt"></i> Covai Areas Making a Difference</h3>
                    ...
                    <a href="/directory/" class="btn btn-success mt-3">Explore Covai Listings</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card h-100 shadow-sm border-0">
                <div class="card-body">
                    ...
                    <p class="lead">Simple, practical steps for Covai residents:</p>
                    <ol>
                        <li><strong>Shop Local:</strong> Buy from Covai businesses listed on <a href="/directory/restaurants.php">our directory</a> - support local economy (SDG 8)</li>
                        <li><strong>Reduce Plastic:</strong> Carry your own bag when shopping in Perungudi or Karapakkam markets (SDG 12)</li>
                        <li><strong>Use Public Transport:</strong> Take Covai buses or carpool - reduce traffic emissions (SDG 11, SDG 13)</li>
                        <li><strong>Volunteer:</strong> Join community events posted on <a href="/local-events/"><?php echo htmlspecialchars($sdg_site); ?> Events</a> (SDG 17)</li>
                        <li><strong>Share Knowledge:</strong> Help neighbors find schools via <a href="/directory/omr-road-schools.php">our school directory</a> (SDG 4)</li>
                        <li><strong>Support Healthcare:</strong> Promote awareness using our <a href="/directory/hospitals.php">hospital listings</a> (SDG 3)</li>
                    </ol>
                </div>
            </div>
        </div>
...
<section id="business-commitment" class="container py-5">
    <div class="section-header">
        <h2>For Covai Businesses: Make a Sustainable Promise</h2>
        <p>Join Covai businesses committing to sustainable practices</p>
    </div>
            ...
            <div class="card h-100 shadow-sm border-left border-success border-4">
                <div class="card-body">
                    ...
                    <ul>
                        ...
                        <li>Support Covai local farmers and suppliers</li>
                    </ul>
                    <p class="small text-muted">Supports: SDG 2, SDG 12, SDG 15</p>
                    <a href="/directory/restaurants.php" class="btn btn-outline-success btn-sm">List Your Restaurant</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 shadow-sm border-left border-primary border-4">
                <div class="card-body">
                    ...
                    <p><strong>I promise to:</strong></p>
                    <ul>
                        <li>Hire 20% more local Covai residents by 2026</li>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 shadow-sm border-left border-warning border-4">
                <div class="card-body">
                    ...
                    <p><strong>I promise to:</strong></p>
                    <ul>
                        <li>Offer scholarships to underprivileged Covai students</li>
                    ...
                    <a href="/directory/omr-road-schools.php" class="btn btn-outline-warning btn-sm">List Your School</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="text-center mt-4">
        ...
        <a href="/contact.php" class="btn btn-success btn-lg">Contact Us to Pledge</a>
    </div>
</section>
...
<section id="pledge-section" class="py-5" style="background: linear-gradient(135deg, #1e3a1e 0%, #2d5a2d 50%, #3d7a3d 100%);">
    <div class="container">
        <div class="section-header">
            <h2 style="color: #d4edda; text-shadow: 2px 2px 4px rgba(0,0,0,0.3);">Coimbatore Community Sustainability Pledge</h2>
            <p style="color: rgba(212,237,218,0.9);">Commit to actions that make Coimbatore a better and more sustainable place</p>
        </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_pledge'])) {
                            ...
                            if (empty($email)) {
                                ...
                                // Build pledge list
                                $pledge_labels = [
                                    'pledge1' => 'Reduce Waste - Use reusable bags and containers for shopping in Covai',
                                    'pledge2' => 'Support Local - Shop at Covai businesses and restaurants listed on MyCovai',
                                    'pledge3' => 'Share Knowledge - Help neighbors find schools, hospitals, or services via MyCovai',
                                    'pledge4' => 'Get Involved - Attend or organize community events listed on MyCovai',
                                    'pledge5' => 'Save Energy - Use public transport or carpool for Covai commute',
                                    'pledge6' => 'Stay Informed - Read MyCovai local news to stay aware of community issues'
                                ];
                                ...
                                $subject = "New Coimbatore Community Sustainability Pledge - " . htmlspecialchars($email);
                                $message = "A new Coimbatore Community Sustainability Pledge has been submitted!\n\n";
                                ...
                                $headers = "From: MyCovai Pledge Form <noreply@mycovai.in>\r\n";
                        ...
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            ...
                            <p>Your Coimbatore Community Sustainability Pledge has been successfully submitted. We'll keep you updated on sustainability initiatives in your community.</p>
                        ...
                        <form method="POST" action="#pledge-section">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <small class="form-text text-muted">We'll use this to keep you updated on Coimbatore sustainability initiatives and communicate about your pledge.</small>
                            </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check pledge-option" style="background: linear-gradient(135deg, #ffffff 0%, #f1f8e9 100%); padding: 20px; border-radius: 12px; border: 2px solid #81c784; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                                        ...
                                        <label class="form-check-label" for="pledge1" style="color: #2e7d32; font-weight: 500; margin-left: 10px; cursor: pointer;">
                                            <strong>Reduce Waste:</strong> Use reusable bags and containers for shopping in Covai
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="form-check pledge-option" style="background: linear-gradient(135deg, #ffffff 0%, #f1f8e9 100%); padding: 20px; border-radius: 12px; border: 2px solid #81c784; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                                        ...
                                        <label class="form-check-label" for="pledge2" style="color: #2e7d32; font-weight: 500; margin-left: 10px; cursor: pointer;">
                                            <strong>Support Local:</strong> Shop at Covai businesses and restaurants listed on MyCovai
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="form-check pledge-option" style="background: linear-gradient(135deg, #ffffff 0%, #f1f8e9 100%); padding: 20px; border-radius: 12px; border: 2px solid #81c784; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                                        ...
                                        <label class="form-check-label" for="pledge3" style="color: #2e7d32; font-weight: 500; margin-left: 10px; cursor: pointer;">
                                            <strong>Share Knowledge:</strong> Help neighbors find schools, hospitals, or services via MyCovai
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="form-check pledge-option" style="background: linear-gradient(135deg, #ffffff 0%, #f1f8e9 100%); padding: 20px; border-radius: 12px; border: 2px solid #81c784; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                                        ...
                                        <label class="form-check-label" for="pledge4" style="color: #2e7d32; font-weight: 500; margin-left: 10px; cursor: pointer;">
                                            <strong>Get Involved:</strong> Attend or organize community events listed on MyCovai
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="form-check pledge-option" style="background: linear-gradient(135deg, #ffffff 0%, #f1f8e9 100%); padding: 20px; border-radius: 12px; border: 2px solid #81c784; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                                        ...
                                        <label class="form-check-label" for="pledge5" style="color: #2e7d32; font-weight: 500; margin-left: 10px; cursor: pointer;">
                                            <strong>Save Energy:</strong> Use public transport or carpool for Covai commute
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="form-check pledge-option" style="background: linear-gradient(135deg, #ffffff 0%, #f1f8e9 100%); padding: 20px; border-radius: 12px; border: 2px solid #81c784; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                                        ...
                                        <label class="form-check-label" for="pledge6" style="color: #2e7d32; font-weight: 500; margin-left: 10px; cursor: pointer;">
                                            <strong>Stay Informed:</strong> Read MyCovai local news to stay aware of community issues
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center mt-4 pt-4" style="border-top: 2px solid #81c784;">
                                <p class="mb-3" style="color: #2e7d32; font-weight: 500;">Share your commitment with the Covai community!</p>
...
<!-- Connect with Coimbatore Resources -->
<section class="container py-5">
    <div class="section-header">
        <h2>Start Taking Action Today</h2>
        <p>Explore these <?php echo htmlspecialchars($sdg_site); ?> resources to begin your sustainable journey</p>
    </div>
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card text-center h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <p class="small">Find quality education options in Covai</p>
                    <a href="/directory/omr-road-schools.php" class="btn btn-sm btn-success">Browse Schools</a>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card text-center h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <h5>Job Listings</h5>
                    <p class="small">Find opportunities in Covai's growing economy</p>
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card text-center h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <h5>Restaurants</h5>
                    <p class="small">Support local Covai food businesses</p>
                    <a href="/directory/restaurants.php" class="btn btn-sm btn-warning">Find Restaurants</a>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6 mb-4">
...
<section id="faq" class="container py-5">
    <header class="section-header">
        ...
        <p>Common questions about the UN Sustainable Development Goals and <?php echo htmlspecialchars($sdg_site); ?>'s role</p>
    </header>
                    ...
                    <div class="card-header" id="faq3">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-left w-100" type="button" data-toggle="collapse" data-target="#collapse3" aria-expanded="false" aria-controls="collapse3">
                                How does <?php echo htmlspecialchars($sdg_site); ?> support the Sustainable Development Goals?
                            </button>
                        </h5>
                    </div>
                    <div id="collapse3" class="collapse" aria-labelledby="faq3" data-parent="#sdgFAQAccordion">
                        <div class="card-body">
                            <p><?php echo htmlspecialchars($sdg_site); ?> supports the SDGs through four primary areas: (1) Sustainable Cities & Communities (SDG 11) via local news and civic engagement, (2) Quality Education (SDG 4) through comprehensive school directories, (3) Decent Work & Economic Growth (SDG 8) via job listings and business directories, and (4) Good Health & Well-being (SDG 3) through healthcare facility directories and wellness content.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-header" id="faq5">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-left w-100" type="button" data-toggle="collapse" data-target="#collapse5" aria-expanded="false" aria-controls="collapse5">
                                How can I participate in supporting the SDGs through <?php echo htmlspecialchars($sdg_site); ?>?
                            </button>
                        </h5>
                    </div>
                    <div id="collapse5" class="collapse" aria-labelledby="faq5" data-parent="#sdgFAQAccordion">
                        <div class="card-body">
                            <p>You can participate in three ways: (1) Individual Actions - Make sustainable choices, support local businesses, and participate in community initiatives, (2) Business Practices - Adopt sustainable business practices and list your business on <?php echo htmlspecialchars($sdg_site); ?>, and (3) Community Initiatives - Join or start community initiatives focused on sustainability, education, health, and social inclusion.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-header" id="faq6">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-left w-100" type="button" data-toggle="collapse" data-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
                                What is SDG 11 and how does <?php echo htmlspecialchars($sdg_site); ?> support it?
                            </button>
                        </h5>
                    </div>
                    <div id="collapse6" class="collapse" aria-labelledby="faq6" data-parent="#sdgFAQAccordion">
                        <div class="card-body">
                            <p>SDG 11 is Sustainable Cities & Communities, aiming to make cities inclusive, safe, resilient and sustainable. <?php echo htmlspecialchars($sdg_site); ?> supports SDG 11 through community news and civic awareness, local business directories promoting sustainable practices, and community events that build social connections.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="cta-section">
    <div class="container">
        ...
        <p>Join the <?php echo htmlspecialchars($sdg_site); ?> community in building a more sustainable future for our neighborhood</p>
