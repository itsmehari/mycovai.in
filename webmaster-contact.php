...
$page_title = 'Contact Webmaster – ' . (defined('SITE_NAME') ? SITE_NAME : 'MyCovai');
...
<body>
    ...
    <main class="contact-container">
        ...
        <p>If you have any technical issues, suggestions, or need to reach the <?php echo htmlspecialchars(defined('SITE_NAME') ? SITE_NAME : 'MyCovai'); ?> webmaster, please use the form below or contact us directly.</p>
        ...
        <div class="contact-details">
            ...
            <ul>
                <li><strong>Email:</strong> <a href="mailto:<?php echo htmlspecialchars($contact_email); ?>"><?php echo htmlspecialchars($contact_email); ?></a></li>
                <li><strong>Phone:</strong> <?php echo htmlspecialchars($contact_phone); ?></li>
            </ul>
        </div>
    </main>
