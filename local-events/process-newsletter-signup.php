...
function endWith($msg) {
  echo '<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
     . '<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet"><title>Subscribed</title></head><body class="p-4">'
     . '<div class="container"><div class="alert alert-info">' . htmlspecialchars($msg) . '</div>'
     . '<a class="btn btn-primary" href="/local-events/index.php">Back to Events</a></div></body></html>';
  exit;
}
