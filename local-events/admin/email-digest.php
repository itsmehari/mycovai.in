...
function emailUrl(string $slug): string {
  $base = '/local-events/event/' . $slug;
  $qs = http_build_query([
    'utm_source' => 'email',
    'utm_medium' => 'mail',
    'utm_campaign' => 'weekly_digest'
  ]);
  return 'https://mycovai.in' . $base . '?' . $qs;
}
            ...
            <tr>
              <td style="padding:18px 20px;">
                ...
                <div style="margin-top:18px;text-align:center;">
                  <a href="https://mycovai.in/local-events/weekend?utm_source=email&utm_medium=mail&utm_campaign=weekly_digest" target="_blank" style="background:#10b981;color:#ffffff;border-radius:6px;padding:10px 16px;display:inline-block;font-size:15px;text-decoration:none;">See all weekend events</a>
                </div>
              </td>
            </tr>
            <tr>
              <td style="background:#f9fafb;padding:14px 20px;color:#6b7280;font-size:12px;text-align:center;">
                You received this because you follow MyCovai Events. <a href="https://mycovai.in/webmaster-contact.php" style="color:#6b7280;">Contact us</a> for feedback.
              </td>
            </tr>
          </table>
        </td>
...
$textLines[] = 'See all weekend events: https://mycovai.in/local-events/weekend?utm_source=email&utm_medium=mail&utm_campaign=weekly_digest';
$textEmail = implode("\n", $textLines);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Email Digest – MyCovai Events</title>
