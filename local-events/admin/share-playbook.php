...
foreach ($events as $e) {
  ...
  $lines[] = '  ' . 'https://mycovai.in' . shareUrl($e['slug'], 'whatsapp');
}
$lines[] = '';
$lines[] = 'More: https://mycovai.in/local-events/weekend?utm_source=whatsapp&utm_medium=social&utm_campaign=weekly_weekend_share';
$whatsappMsg = implode("\n", $lines);
...
foreach ($events as $e) {
  ...
  $tLines[] = '  ' . 'https://mycovai.in' . shareUrl($e['slug'], 'telegram');
}
$tLines[] = '';
$tLines[] = 'More: https://mycovai.in/local-events/weekend?utm_source=telegram&utm_medium=social&utm_campaign=weekly_weekend_share';
$telegramMsg = implode("\n", $tLines);
?>
<!DOCTYPE html>
<html lang="en">
