...
$events = getEventsByVenue($venueLabel, $per_page, $offset);
$total = getEventCountByVenue($venueLabel); $pages = max(1, (int)ceil($total / $per_page));
...
$page_title = $venueLabel . ' – Upcoming Events | ' . $sn;
$page_description = 'Upcoming events at ' . $venueLabel . ' in ' . $rf . '. Timings, venue map, and details.';
$canonical_url = $base . '/local-events/venue/' . rawurlencode($slug);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="dashboard-header">
  <div class="container d-flex flex-wrap justify-content-between align-items-center">
    <div class="mb-2 mb-md-0">
      <div class="title h1 mb-0">Events at <?php echo htmlspecialchars($venueLabel); ?></div>
  ...
  <div class="container">
    <div class="row">
      <?php if (count($events) === 0): ?>
        <div class="col-12"><div class="alert-modern">No upcoming events at this venue.</div></div>
