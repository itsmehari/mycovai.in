...
$page_title = 'This Month in ' . $rf . ' – Events | ' . $sn;
$page_description = 'Plan ahead with events this month in ' . $rf . ': community, arts, sports, workshops and more.';
$canonical_url = $base . '/local-events/month';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="dashboard-header">
  <div class="container d-flex flex-wrap justify-content-between align-items-center">
    <div class="mb-2 mb-md-0">
      ...
      <div class="small opacity-90">Plan your month in <?php echo htmlspecialchars($rf); ?></div>
    </div>
