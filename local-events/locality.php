...
$page_title = 'Events in ' . $localityLabel . ' – OMR Chennai | MyOMR';
$page_description = 'Discover events happening in ' . $localityLabel . ' along Old Mahabalipuram Road (OMR): timings, venues, and details.';
$canonical_url = 'https://mycovai.in/local-events/locality/' . urlencode($slug);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="dashboard-header">
  <div class="container d-flex flex-wrap justify-content-between align-items-center">
    <div class="mb-2 mb-md-0">
      <div class="title h1 mb-0">Events in <?php echo htmlspecialchars($localityLabel); ?></div>
      <div class="small opacity-90">All upcoming events around <?php echo htmlspecialchars($localityLabel); ?> on OMR</div>
    </div>
...
<main class="py-5">
  <div class="container">
    <div class="card-modern mb-4"><div class="p-4">
      <p>Find community, cultural, sports and workshop events across <?php echo htmlspecialchars($localityLabel); ?>. New listings are added regularly. Organizers can <a href="post-event-omr.php">submit an event</a> for free.</p>
    </div></div>
