...
$page_title = 'Events in ' . $localityLabel . ' – ' . $rf . ' | ' . $sn;
$page_description = 'Discover events happening in ' . $localityLabel . ', ' . $rf . ': timings, venues, and details.';
$canonical_url = $base . '/local-events/locality/' . rawurlencode($slug);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="dashboard-header">
  <div class="container d-flex flex-wrap justify-content-between align-items-center">
    <div class="mb-2 mb-md-0">
      ...
      <div class="small opacity-90">Upcoming events around <?php echo htmlspecialchars($localityLabel); ?>, <?php echo htmlspecialchars($rf); ?></div>
    </div>
...
<main class="py-5">
  <div class="container">
    <div class="card-modern mb-4"><div class="p-4">
      <p>Find community, cultural, sports and workshop events across <?php echo htmlspecialchars($localityLabel); ?>. New listings are added regularly. Organizers can <a href="post-event-covai.php">submit an event</a> for free.</p>
    </div></div>
