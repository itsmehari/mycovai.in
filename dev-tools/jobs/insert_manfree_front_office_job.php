<?php
/**
 * Insert or update Manfree Technologies front office executive job on live DB.
 *
 * Usage:
 *   php dev-tools/jobs/insert_manfree_front_office_job.php
 */
...
$employerData = [
    'company_name'   => 'Manfree Technologies',
    'contact_person' => 'Hiring Team',
    'email'          => 'info@manfreetechnologies.com',
    'phone'          => '',
...
$jobData = [
    ...
    'description'  => "Manfree Technologies, a training institute based in SITRA, Coimbatore, is hiring a Front Office Executive to manage student enquiries and handle administrative tasks.",
    'requirements' => implode("\n", [
        'Experience: 0-2 years',
        'Good communication skills in Tamil and English',
        'Basic computer knowledge and organizational skills',
        'Handle student enquiries (in-person, phone, and online)',
        'Manage front office operations',
        'Maintain records and basic administrative work',
        'Coordinate with trainers and students',
    ]),
    'benefits'     => 'Salary: ₹10,000 - ₹15,000 per month',
