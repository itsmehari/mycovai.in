...
$t = covai_table('atms');
$sql = "SELECT slno, bankname, address, contact, landmark FROM `$t` WHERE 1=1";
if ($filter_q !== '') {
    $esc = $conn->real_escape_string($filter_q);
    $sql .= " AND (bankname LIKE '%{$esc}%' OR address LIKE '%{$esc}%' OR landmark LIKE '%{$esc}%')";
}
if ($filter_locality !== '') {
...
<title>ATMs in Coimbatore | MyCovai</title>

<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Find ATMs in Coimbatore (Covai). Get bank names, addresses, contacts, and landmarks for convenient cash access.">
<meta name="keywords" content="Coimbatore, Covai, MyCovai, ATMs, RS Puram, Gandhipuram, Peelamedu, Saravanampatti, Tamil Nadu">
...
<meta name="twitter:title" content="ATMs in Coimbatore | MyCovai" />
<meta name="twitter:description" content="Find ATMs in Coimbatore (Covai). Get bank names, addresses, contacts, and landmarks for convenient cash access." />
...
<div class="container maxw-1280" id="main-content" role="main">
  <h1 class="text-center text-primary-omr">ATMs in Coimbatore – Directory</h1>
  <?php echo covai_directory_active_filters_markup('/directory/atms.php', $filter_q, $filter_locality); ?>
  <?php


if ($result->num_rows > 0) {
    echo "<div class='container'>";
    echo "<h2 style='text-align:center; margin-bottom:20px;'>ATMs in Coimbatore (Covai)</h2>";
    ...
    echo "<p style='text-align:center;'>No ATMs found in Coimbatore.</p>";
}
