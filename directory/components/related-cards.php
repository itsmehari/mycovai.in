  ...
  <?php foreach ($relatedItems as $item): ?>
    <div class="col-md-4 mb-3">
      <div class="card h-100">
        ...
        ?>
        <img class="card-img-top" src="<?php echo htmlspecialchars($img); ?>" alt="<?php echo htmlspecialchars($item['name']); ?>">
        <div class="card-body">
...
// Optional: $fallbackImage (default SITE_LOGO_URL or '/My-OMR-Logo.jpg')

if (!isset($relatedItems) || !is_array($relatedItems)) { $relatedItems = []; }
if (!isset($fallbackImage) || !is_string($fallbackImage) || $fallbackImage === '') { $fallbackImage = (defined('SITE_LOGO_URL') && SITE_LOGO_URL !== '') ? SITE_LOGO_URL : '/My-OMR-Logo.jpg'; }
...
<div class="row">
  ...
  <div class="col-md-4 mb-3">
    <div class="card h-100">
      <img class="card-img-top" src="<?php echo htmlspecialchars($imgSrc, ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($nm, ENT_QUOTES, 'UTF-8'); ?>" style="object-fit:contain;height:120px;background:#f8fafc;">
      <div class="card-body">
