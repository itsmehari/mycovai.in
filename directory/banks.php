...
<html lang="en">
<head>
<?php $breadcrumbs = [ ['https://mycovai.in/','Home'], ['https://mycovai.in/directory/banks.php','Banks'] ]; ?>
...
<div class="container maxw-1280" id="main-content" role="main">
  ...
  <?php if (!empty($res['items'])): ?>
    ...
    <script type="application/ld+json">
      <?php echo json_encode(['@context'=>'https://schema.org','@type'=>'ItemList','name'=>'Banks in Coimbatore','itemListElement'=>$itemList], JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE); ?>
    </script>
  <?php else: ?>
    <p>No banks found.</p>
  <?php endif; ?>
