...
$localities = $conn->query("SELECT DISTINCT locality FROM `$tRest` ORDER BY locality");
$cuisines = $conn->query("SELECT DISTINCT cuisine FROM `$tRest` ORDER BY cuisine");
?>
...
<head>
    ...
    <meta name="description" content="Explore vegetarian restaurants in Coimbatore. Find restaurant names, addresses, cuisines, ratings, and more at MyCovai.in.">
    <meta name="keywords" content="Vegetarian Restaurants Coimbatore, Covai Dining, MyCovai, RS Puram, Gandhipuram, Peelamedu, Saibaba Colony, Saravanampatti">
    ...
    <!-- Title -->
    <title>Vegetarian Restaurants in Coimbatore | MyCovai</title>
