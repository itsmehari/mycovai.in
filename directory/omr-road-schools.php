...
<html lang="en">
<head>
    <!-- Base URL to ensure links resolve correctly -->
    <base href="https://mycovai.in/">

    <!-- Meta Tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Explore top schools along Coimbatore. Find school names, addresses, curricula, ratings, and more at MyCovai.">
    <meta name="keywords" content="Schools Coimbatore, Covai Schools, MyCovai, RS Puram, Gandhipuram, Peelamedu, Saravanampatti, Tamil Nadu">
    ...
    <!-- Canonical URL -->
    <link rel="canonical" href="https://mycovai.in/directory/schools-list.php">
            ...
            <?php if ($result->num_rows > 0): ?>
                <?php while ($row = $result->fetch_assoc()): ?>
                    ...
                    <script type="application/ld+json">
                    {
                        ...
                        "image": "<?php echo htmlspecialchars($row['logo_url'] ?? 'https://mycovai.in/images/schools/default.jpg'); ?>",
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100 border-success shadow-sm">
                            <img src="<?php echo htmlspecialchars($row['logo_url'] ?? 'https://mycovai.in/images/schools/default.jpg'); ?>" class="card-img-top lazyload" alt="<?php echo htmlspecialchars($row['school_name']); ?>" loading="lazy">
            ...
            ?>
                <div class="col-md-4 mb-4">
                    <div class="card h-100 border-warning shadow-sm">
                        <img src="<?php echo htmlspecialchars($featured['logo_url'] ?? 'https://mycovai.in/images/schools/default.jpg'); ?>" class="card-img-top lazyload" alt="<?php echo htmlspecialchars($featured['school_name']); ?>" loading="lazy">
                        <div class="card-body">
