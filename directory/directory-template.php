...
<head>
    ...
    <meta name="keywords" content="Coimbatore, Covai, MyCovai, <?php echo ucfirst($directory_type); ?>, <?php echo defined('SITE_NAME') ? htmlspecialchars(SITE_NAME) : 'MyCovai'; ?>">
    <meta name="author" content="<?php echo defined('SITE_NAME') ? htmlspecialchars(SITE_NAME) . ' Team' : 'MyCovai Team'; ?>">
    
    <title><?php echo htmlspecialchars($config['title']); ?> | <?php echo defined('SITE_NAME') ? htmlspecialchars(SITE_NAME) : 'MyCovai'; ?></title>
    ...
    <!-- Canonical URL -->
    <link rel="canonical" href="https://mycovai.in/directory/<?php echo $directory_type; ?>.php">
