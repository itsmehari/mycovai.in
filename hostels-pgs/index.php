...
$page_title = defined('MYCOVAI_CONFIG_LOADED') ? "Hostels & PGs in " . $region_full . " – Find Safe Accommodation | " . $site_name : "Hostels & PGs in OMR Chennai - Find Safe Accommodation | MyOMR";
$page_description = defined('MYCOVAI_CONFIG_LOADED') ? "Find hostels and paying guest accommodations in " . $region_full . ". Boys PG, Girls Hostel, student-friendly options. Safe and affordable living in " . $region_short . "." : "Find 100+ hostels and paying guest accommodations in OMR Chennai. Boys PG, Girls Hostel, student-friendly options with verified properties. Safe and affordable living spaces.";
$canonical_url = (defined('SITE_CANONICAL_BASE') ? SITE_CANONICAL_BASE : 'https://mycovai.in') . '/hostels-pgs/';

// Build filter URL for pagination
$filter_params = http_build_query($filters);
$base_url = "/hostels-pgs/";
...
<head>
    ...
    <meta name="keywords" content="<?php echo defined('MYCOVAI_CONFIG_LOADED') ? 'PG Coimbatore, hostels Covai, boys PG Coimbatore, girls hostel Covai, student accommodation Coimbatore' : 'PG in OMR, hostels in OMR Chennai, boys PG OMR, girls hostel OMR, student accommodation OMR, affordable hostel OMR'; ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebSite",
        "name": "<?php echo htmlspecialchars($site_name); ?> Hostels & PGs",
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        {"@type": "ListItem", "position": 2, "name": "Hostels & PGs in <?php echo htmlspecialchars($region_short); ?>", "item": "<?php echo $canonical_url; ?>"}
      ]
    }
    </script>
    <script type="application/ld+json">
    ...
    <section class="hero-section hero-modern text-white py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="display-4 fw-bold mb-3 hero-modern-title">Find Your Perfect Home in <?php echo htmlspecialchars($region_short); ?></h1>
                    <p class="lead mb-4 hero-modern-subtitle">Discover safe, comfortable, and affordable hostels & PG accommodations for students and professionals in <?php echo htmlspecialchars($region_full); ?>.</p>
                ...
                <div class="col-md-6">
                    <form method="GET" class="advanced-filters d-flex gap-2 flex-wrap">
                        ...
                        <?php if (!empty($filters)): ?>
                            <a href="/hostels-pgs/" class="btn btn-outline-secondary btn-sm">
                            ...
                            <article class="property-card card-modern h-100 position-relative">
                                ...
                                <header class="property-card-header">
                                    ...
                                    <div class="property-card-location">
                                        ...
                                        <?php echo htmlspecialchars($property['locality'] ?? $region_short); ?>
                                    </div>
                                ...
                                <footer class="property-card-footer">
                                    ...
                                    <div class="property-actions">
                                        <a href="/hostels-pgs/property-detail.php?id=<?php echo $property['id']; ?>" 
                    ...
                    <div class="col-12 text-center py-5">
                        <div class="no-results">
                            ...
                            <p class="text-muted mb-4">
                                <?php if (!empty($filters)): ?>
                                    Try adjusting your search criteria or <a href="/hostels-pgs/">browse all properties</a>.
                                <?php else: ?>
                                    No properties available at the moment. Check back soon for new listings!
                                <?php endif; ?>
                            </p>
                            <a href="/hostels-pgs/" class="btn btn-primary">
        ...
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <p class="lead mb-4">List your hostel or PG and connect with thousands of students and professionals in <?php echo htmlspecialchars($region_short); ?>.</p>
