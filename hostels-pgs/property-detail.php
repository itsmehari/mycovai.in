...
$page_description = strlen($clean_description) > 155
    ...
    : $clean_description;
$canonical_url = "https://mycovai.in/hostels-pgs/property-detail.php?id=" . $property_id;
$og_image = "https://mycovai.in/hostels-pgs/" . htmlspecialchars($property['featured_image'] ?? 'My-OMR-Logo.jpg');
...
<head>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        {"@type": "ListItem", "position": 2, "name": "Hostels & PGs in OMR", "item": "https://mycovai.in/hostels-pgs/"},
        ...
        <div class="row mt-5">
            <div class="col-12">
                ...
                <div class="text-center mt-4">
                    <a href="/hostels-pgs/index.php?locality=<?php echo urlencode($property['locality']); ?>" class="btn btn-outline-primary">
