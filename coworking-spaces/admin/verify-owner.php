    ...
    if ($owner_id > 0) {
        if ($action === 'verify') {
            ...
            if ($emailData && !empty($emailData['email'])) {
                ...
                $html .= '<p><a href="https://mycovai.in/coworking-spaces/owner-login.php" style="background: #008552; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Login to Dashboard</a></p>';
