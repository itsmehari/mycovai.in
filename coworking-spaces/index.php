...
// Localities for filter dropdown (Phase 4/5.1: config SITE_AREAS when loaded)
$localities = defined('MYCOVAI_CONFIG_LOADED') && defined('SITE_AREAS') ? SITE_AREAS : ['All of OMR', 'Navalur', 'Sholinganallur', 'Thoraipakkam', 'Kandhanchavadi', 'Perungudi', 'Okkiyam Thuraipakkam'];
...
$page_title = defined('MYCOVAI_CONFIG_LOADED') ? "Coworking Spaces in " . $region_full . " – Find Flexible Workspaces | " . $site_name : "Coworking Spaces in OMR Chennai - Find Flexible Workspaces | MyOMR";
$page_description = defined('MYCOVAI_CONFIG_LOADED') ? "Discover coworking spaces in " . $region_full . ". Day pass, hot desk, dedicated desk with WiFi, meeting rooms, 24/7 access. Affordable workspaces in " . $region_short . "." : "Discover 50+ coworking spaces in OMR Chennai. Day pass, hot desk, dedicated desk options with high-speed WiFi, meeting rooms, and 24/7 access. Affordable workspaces for freelancers and startups.";
$canonical_url = (defined('SITE_CANONICAL_BASE') ? SITE_CANONICAL_BASE : 'https://mycovai.in') . '/coworking-spaces/';

// Build filter URL for pagination
$filter_params = http_build_query($filters);
$base_url = "/coworking-spaces/";
...
<head>
    ...
    <meta name="keywords" content="<?php echo defined('MYCOVAI_CONFIG_LOADED') ? 'coworking Coimbatore, shared office Covai, day pass coworking Coimbatore, hot desk Covai, workspace Coimbatore' : 'coworking OMR, shared office OMR Chennai, day pass coworking OMR, hot desk OMR, workspace OMR'; ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebSite",
        "name": "<?php echo htmlspecialchars($site_name); ?> Coworking Spaces",
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        {"@type": "ListItem", "position": 2, "name": "Coworking Spaces in <?php echo htmlspecialchars($region_short); ?>", "item": "<?php echo $canonical_url; ?>"}
      ]
    }
    </script>
    <script type="application/ld+json">
    ...
    <section class="hero-section hero-modern text-white py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="display-4 fw-bold mb-3 hero-modern-title">Find Your Perfect Workspace in <?php echo htmlspecialchars($region_short); ?></h1>
                    <p class="lead mb-4 hero-modern-subtitle">Discover flexible, affordable coworking spaces for freelancers, startups, and remote professionals in <?php echo htmlspecialchars($region_full); ?>.</p>
                ...
                <div class="col-md-6">
                    <form method="GET" class="advanced-filters d-flex gap-2 flex-wrap">
                        ...
                        <?php if (!empty($filters)): ?>
                            <a href="/coworking-spaces/" class="btn btn-outline-secondary btn-sm">
                            ...
                            <article class="space-card card-modern h-100 position-relative">
                                ...
                                <header class="space-card-header">
                                    ...
                                    <div class="space-card-location">
                                        ...
                                        <?php echo htmlspecialchars($space['locality'] ?? $region_short); ?>
                                    </div>
                    ...
                    <div class="col-12 text-center py-5">
                        <div class="no-results">
                            ...
                            <p class="text-muted mb-4">
                                <?php if (!empty($filters)): ?>
                                    Try adjusting your search criteria or <a href="/coworking-spaces/">browse all spaces</a>.
                                <?php else: ?>
                                    No coworking spaces available at the moment. Check back soon for new listings!
                                <?php endif; ?>
                            </p>
                            <a href="/coworking-spaces/" class="btn btn-primary">
        ...
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <p class="lead mb-4">List your coworking space and connect with thousands of freelancers, startups, and remote professionals in <?php echo htmlspecialchars($region_short); ?>.</p>
