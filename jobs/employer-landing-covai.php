...
<head>
    ...
    <title>Employer Portal – <?php echo htmlspecialchars(defined('SITE_NAME') ? SITE_NAME : 'MyCovai'); ?> Job Portal</title>
    ...
    <div class="container">
        ...
        <?php if ($isLoggedIn): ?>
            ...
            <div class="row g-4 mb-5">
                <div class="col-md-4">
                    <a href="post-job-covai.php" class="text-decoration-none">
                ...
                <div class="col-md-4">
                    <a href="my-posted-jobs-covai.php" class="text-decoration-none">
                        <div class="card-modern p-5 text-center option-card h-100">
                ...
                <div class="col-lg-8">
                    <div class="card-modern p-5 text-center mb-4">
                        ...
                        <div class="d-flex gap-3 justify-content-center flex-wrap">
                            <a href="employer-login-covai.php?redirect=employer-landing-covai.php" class="btn btn-primary btn-lg">
                                <i class="fas fa-sign-in-alt me-2"></i>Login
                            </a>
                            <a href="employer-register-covai.php" class="btn btn-outline-primary btn-lg">
