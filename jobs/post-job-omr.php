...
try {
    ...
    if (defined('DEVELOPMENT_MODE') && DEVELOPMENT_MODE) {
        error_log("Loaded " . count($categories) . " job categories in post-job-omr.php");
...
$page_title = defined('MYCOVAI_CONFIG_LOADED') ? "Post a Job in " . $region_full . " | " . $site_name : "Post Job Vacancy in OMR - Reach 1000+ Job Seekers | MyOMR";
$page_description = defined('MYCOVAI_CONFIG_LOADED') ? "Post your job vacancy on " . $site_name . ". Reach qualified candidates in " . $region_full . ". Free job listings for employers." : "Post your job vacancy on MyOMR. Reach qualified candidates in OMR Chennai. Free job listings for employers.";
$canonical_url = (defined('SITE_CANONICAL_BASE') ? SITE_CANONICAL_BASE : 'https://mycovai.in') . '/jobs/post-job-omr.php';
