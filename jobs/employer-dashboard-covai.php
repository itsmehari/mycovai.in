<?php
/**
 * MyCovai Job Portal – Employer dashboard (applications)
 *
...
// SEO Meta
$page_title = "Employer Dashboard – Applications | MyCovai";
$page_description = "Manage job applications, filter candidates, and track your hiring pipeline on MyCovai.";
$canonical_url = "https://mycovai.in/jobs/employer-dashboard-covai.php";
?>
    ...
    <div class="container">
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 text-white">
            ...
            <div class="d-flex gap-2 flex-wrap">
                <a class="btn btn-light" href="my-posted-jobs-covai.php">
                    <i class="fas fa-list me-2"></i>My Jobs
                </a>
                <a class="btn btn-outline-light" href="post-job-covai.php">
                ...
                <div class="dashboard-sidebar card-modern p-0">
                    ...
                    <div class="sidebar-section border-top">
                        <div class="d-flex justify-content-between align-items-center p-3 border-bottom">
                            ...
                            <a href="employer-dashboard-covai.php" class="text-muted small text-decoration-none">Clear all</a>
                        </div>
                    </div>
                ...
                <div id="applications-list">
                    ...
                    <?php else: ?>
                        <div class="card-modern p-5 text-center">
                            ...
                            <a href="post-job-covai.php" class="btn btn-primary">
