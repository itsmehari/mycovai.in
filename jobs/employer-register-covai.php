<?php
/**
 * Employer Registration – MyCovai Job Portal
...
$redirect = isset($_GET['redirect']) ? $_GET['redirect'] : 'my-posted-jobs-covai.php?registered=1';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($company_name === '' || !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if (employerEstablishSession($email)) {
...
<head>
    ...
    <title>Register as Employer – MyCovai Job Portal</title>
                ...
                <div class="card-modern">
                    <div class="p-4">
                        ...
                        <p class="mb-0 text-center text-muted">
                            Already registered? <a href="employer-login-covai.php" class="text-primary fw-semibold">Login here</a>
                            <br>
                            Or you can <a href="post-job-covai.php" class="text-primary fw-semibold">post a job</a> directly and we’ll create your profile.
                        </p>
                    </div>
                </div>
            </div>
