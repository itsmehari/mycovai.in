<?php
/**
 * MyCovai Job Portal – Job posted success
 *
...
<head>
    ...
    <title>Job Posted Successfully – MyCovai Job Portal</title>
    <!-- Google Fonts -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="text-center d-flex gap-3 flex-wrap justify-content-center">
                    ...
                    <a href="post-job-covai.php" class="btn-modern btn-modern-secondary">
