<?php
/**
 * MyCovai Job Portal – Application submitted
 *
...
<head>
    ...
    <title>Application Submitted Successfully – MyCovai Job Portal</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="text-center d-flex gap-3 flex-wrap justify-content-center">
                    ...
                    <?php if ($job_id > 0): ?>
                    <a href="<?php echo htmlspecialchars(getJobDetailUrl($job_id, $job['title'] ?? '')); ?>" class="btn-modern btn-modern-secondary">
