...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'bulk' && isset($_POST['bulk_action']) && is_array($_POST['ids'] ?? null)) {
        ...
        if (in_array($bulkAction, ['approve', 'reject'], true)) {
            ...
            header('Location: manage-jobs-covai.php?success=1');
            exit;
        }
    }
...
<head>
    ...
    <title>Manage Jobs - Admin Dashboard | MyCovai</title>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                ...
                                <?php endif; ?>
                                <a href="<?php echo htmlspecialchars(getJobDetailUrl($job['id'], $job['title'] ?? '')); ?>" target="_blank" class="btn btn-outline-secondary"><i class="fas fa-eye"></i></a>
                                <a href="view-applications-covai.php?id=<?php echo (int)$job['id']; ?>" class="btn btn-outline-primary"><i class="fas fa-inbox"></i></a>
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
