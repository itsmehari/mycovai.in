<?php
/**
 * MyCovai Job Portal – job detail page (application form)
 *
...
if (session_status() === PHP_SESSION_NONE) {
    ...
    if ($sessionPath !== '') {
        // Some hosts prepend N;MODE;/path - last segment is the path.
...
$jobStmt = $conn->prepare(
    "SELECT j.*, e.company_name, e.contact_person, e.email AS employer_email,
...
$page_description = strlen($clean_description) > 155
    ...
    : $clean_description;
$canonical_path = getJobDetailUrl($job_id, $job['title'] ?? '');
$canonical_url = (defined('SITE_CANONICAL_BASE') ? SITE_CANONICAL_BASE : 'https://mycovai.in') . $canonical_path;
$og_image = "https://mycovai.in/My-OMR-Logo.jpg";

// Force canonical slug URL for SEO consistency.
$requestPath = parse_url($_SERVER['REQUEST_URI'] ?? '', PHP_URL_PATH) ?: '';
if ($requestPath !== '' && rtrim($requestPath, '/') !== rtrim($canonical_path, '/')) {
...
<head>
    ...
    <meta name="keywords" content="<?php echo htmlspecialchars($job['title']); ?>, <?php echo htmlspecialchars($job['location']); ?>, jobs in <?php echo htmlspecialchars(defined('SITE_REGION_SHORT') ? SITE_REGION_SHORT : 'Coimbatore'); ?>">
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        {"@type": "ListItem", "position": 2, "name": "Jobs in <?php echo htmlspecialchars(defined('SITE_REGION_SHORT') ? SITE_REGION_SHORT : 'Coimbatore'); ?>", "item": "<?php echo defined('SITE_CANONICAL_BASE') ? SITE_CANONICAL_BASE : 'https://mycovai.in'; ?>/jobs/"},
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="index.php">Jobs in <?php echo htmlspecialchars(defined('SITE_REGION_SHORT') ? SITE_REGION_SHORT : 'Coimbatore'); ?></a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <?php
                $jobPosterPath = __DIR__ . '/assets/posters/job-' . $job_id . '.png';
                if (is_file($jobPosterPath)):
                ?>
                <div class="job-content-section mb-4">
                    <h2><i class="fas fa-image me-2"></i>Hiring Poster</h2>
                    <figure class="mb-0">
                        <img src="/jobs/assets/posters/job-<?php echo (int) $job_id; ?>.png"
                             alt="<?php echo htmlspecialchars($job['title'] . ' – ' . $job['company_name']); ?> hiring poster"
                ...
                <div class="row related-jobs">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="job-card h-100">
                            <h4 class="h6 mb-2">
                                <a href="<?php echo htmlspecialchars(getJobDetailUrl($related['id'], $related['title'] ?? '')); ?>">
...
<div class="modal fade" id="applyModal" tabindex="-1" aria-labelledby="applyModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="process-application-covai.php" method="POST" id="applyForm">
