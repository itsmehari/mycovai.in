<?php
/**
 * MyCovai Job Portal – Edit job form
 *
...
if ($job_id <= 0) {
    header('Location: my-posted-jobs-covai.php');
    exit;
}
...
// SEO Meta
$page_title = "Edit Job Posting – " . htmlspecialchars($job['title']) . " | MyCovai";
$page_description = "Edit your job posting on MyCovai.";
$canonical_url = "https://mycovai.in/jobs/edit-job-covai.php?id=" . $job_id;
...
<main id="main-content">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-end">
                    <a href="my-posted-jobs-covai.php" class="btn btn-light btn-sm">
    ...
    <section class="py-5 bg-light">
        <div class="container">
            ...
            <form method="POST" action="process-job-covai.php" id="edit-job-form" class="needs-validation" novalidate>
                ...
                <div class="form-section">
                    <div class="d-flex gap-3 flex-wrap">
                        ...
                        <a href="my-posted-jobs-covai.php" class="btn-modern btn-modern-secondary">
                            <i class="fas fa-times"></i>
                            <span>Cancel</span>
                        </a>
                        <a href="<?php echo htmlspecialchars(getJobDetailUrl($job_id, $job['title'] ?? '')); ?>" class="btn-modern btn-modern-secondary" target="_blank">
