...
<head>
    ...
    <title>Edit Profile – Employer Dashboard | MyCovai</title>
    ...
    <div class="container">
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 text-white">
            ...
            <div class="d-flex gap-2 flex-wrap">
                <a class="btn btn-light" href="my-posted-jobs-covai.php"><i class="fas fa-arrow-left me-2"></i>Back to Dashboard</a>
            </div>
        </div>
    </div>
</section>
