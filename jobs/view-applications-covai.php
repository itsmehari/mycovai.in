<?php
/**
 * MyCovai Job Portal – View applications
 *
...
if ($job_id <= 0) {
    header('Location: my-posted-jobs-covai.php?error=invalid_job');
    exit;
}
...
if (!$job) {
    header('Location: my-posted-jobs-covai.php?error=not_found');
    exit;
}
...
if ($job['employer_id'] != $employerId) {
    ...
    if (!empty($employerEmail) && $job['employer_email'] !== $employerEmail) {
        header('Location: my-posted-jobs-covai.php?error=unauthorized');
        exit;
    }
}
...
// SEO Meta
$page_title = "Applications for " . htmlspecialchars($job['title']) . " | MyCovai";
$page_description = "View applications for your job posting on MyCovai Job Portal.";
$canonical_url = "https://mycovai.in/jobs/view-applications-covai.php?id=" . $job_id;
?>
    ...
    <div class="container">
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 text-white">
            ...
            <div class="d-flex gap-2 flex-wrap">
                <a class="btn btn-light" href="employer-dashboard-covai.php?job_id=<?php echo $job_id; ?>">
                    <i class="fas fa-briefcase me-2"></i>Unified Dashboard
                </a>
                <a class="btn btn-outline-light" href="my-posted-jobs-covai.php">
                    <i class="fas fa-arrow-left me-2"></i>Back to Jobs
                </a>
                <a class="btn btn-outline-light" href="<?php echo htmlspecialchars(getJobDetailUrl($job_id, $job['title'] ?? '')); ?>" target="_blank">
                ...
                <?php foreach ($applications as $app): ?>
                    <div class="application-card">
                        ...
                        <div class="mt-3 d-flex gap-2">
                            ...
                            <form method="POST" action="update-application-status-covai.php" class="d-inline" onsubmit="return confirm('Mark this application as reviewed?');">
        ...
        <?php else: ?>
            ...
            <div class="card-modern p-5 text-center">
                ...
                <div class="d-flex justify-content-center gap-3 flex-wrap">
                    <a href="<?php echo htmlspecialchars(getJobDetailUrl($job_id, $job['title'] ?? '')); ?>" class="btn btn-primary" target="_blank">
                        <i class="fas fa-share-alt me-2"></i>Share Job Posting
                    </a>
                    <a href="my-posted-jobs-covai.php" class="btn btn-outline-secondary">
